...
func (sortedSet *SortedSet) GetFirst() *Element {
	return &sortedSet.skiplist.header.Element
}
func (sortedSet *SortedSet) GetLast() *Element {
	return &sortedSet.skiplist.tail.Element
}
